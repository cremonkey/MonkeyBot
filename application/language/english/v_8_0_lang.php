...
$lang = array(
    ...
    "see features in action" => "Start Converting Conversations",
    ...
    "few steps to connect your facebook & instagram account and make this app work." => "Connect your accounts, train monkey bot on your products, and let it automatically reply to every comment and message with personalized sales responses.",
    "complete marketing software for facebook/instagram in very reasonable price" => "Professional AI sales software for Facebook & Instagram at a reasonable price",
    ...
    "how does this app work?" => "How monkey bot Sells for You",
    ...
    "developed using facebook official api" => "Powered by Advanced AI",
    "revolutionary, world's very first, and complete marketing software for facebook & other social medias developed using official apis." => "monkey bot is a professional AI sales assistant that reads every comment and message, then replies with customized responses designed to engage customers and close more sales — instantly, 24/7.",
    "quick video" => "Quick video",
    "lightning-fast replies 24/7" => "Lightning-Fast Replies 24/7",
    "ai sales assistant that replies, engages & converts" => "AI Sales Assistant That Replies, Engages & Converts",
    "monkey bot reads every comment and message, then replies with customized responses designed to engage customers and close more sales — instantly, 24/7." => "monkey bot reads every comment and message, then replies with customized responses designed to engage customers and close more sales — instantly, 24/7.",
    "start selling smarter" => "Start Selling Smarter",
    "ai online" => "AI Online",
    "avg reply" => "Avg Reply",
    "personalized" => "Personalized",
    "ai-powered replies" => "AI-Powered Replies",
    "smart ai understands customer intent and replies naturally to build trust and drive action." => "Smart AI understands customer intent and replies naturally to build trust and drive action.",
    "customized responses" => "Customized Responses",
    "every reply is tailored to the exact comment or message so customers feel heard, not spammed." => "Every reply is tailored to the exact comment or message so customers feel heard, not spammed.",
    "lightning-fast speed" => "Lightning-Fast Speed",
    "fast response speed is what attracts and engages customers. reply in seconds, never miss a lead." => "Fast response speed is what attracts and engages customers. Reply in seconds, never miss a lead.",
    "professional sales tool" => "Professional Sales Tool",
    "this is not just a bot. monkey bot is built specifically to sell to your customers and grow revenue." => "This is not just a bot. monkey bot is built specifically to sell to your customers and grow revenue.",

    "awesome features" => "Why monkey bot Wins Sales",
    ...
    "get the greatest app!" => "Turn Conversations into Sales!",
    "what if i face issues?" => "Is monkey bot only a chatbot?",
    "yes, you can. we have full-featured image editor integrated with the system. you can crop, add text, add shape, add filters etc. before you post images." => "No — monkey bot is a professional sales tool. It is designed specifically to sell to your customers by turning every conversation into a meaningful, fast, and personalized sales opportunity.",
    "post (video)" => "Post (video)",
    "can i edit images before posting?" => "Can I customize the AI replies?",
    "not at all. we are using instgram official api. everything is official here. don't need to worry." => "Yes. Fast response speed is what attracts and engages customers. monkey bot replies instantly, 24/7, so you never lose a hot lead.",
    "is there any risk involved with my instagram?" => "Is response speed really that important?",
    "no, you don't need to create any facebook app. we are covering all the complex stuff and giving you the easiest experience possible. just import your account and start using the awesome features." => "monkey bot reads each comment and message, understands the context, and automatically generates a customized reply designed to engage the customer and move them toward a purchase — no manual work needed.",
    ...
    "do i need to create facebook app?" => "How does monkey bot use AI?",
