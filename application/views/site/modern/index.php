...
Theme Name: Modern 
Unique Name: modern
Theme URI: https://monkeybot.local
Author: Xerone IT
Author URI: https://xeroneit.net
Version: 1.0
Description: monkey bot front-end theme — professional AI sales assistant landing page. 
*/
?>
<!doctype html>
			...
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6">
					<div class="hero-content">
						<div class="hero-badge wow fadeInUp" data-wow-delay=".1s">
							<span class="badge-icon"><i class="lni lni-bolt-alt"></i></span>
							<span><?php echo $this->lang->line("Lightning-Fast Replies 24/7"); ?></span>
						</div>
						<h2 class="wow fadeInUp" data-wow-delay=".2s"><?php echo $this->config->item('product_name'); ?></h2>
						<h3 class="wow fadeInUp" data-wow-delay=".25s"> <?php echo $this->lang->line("AI Sales Assistant That Replies, Engages & Converts"); ?></h3><br>
						<p class="wow fadeInUp" data-wow-delay=".4s"><?php echo $this->lang->line("monkey bot reads every comment and message, then replies with customized responses designed to engage customers and close more sales — instantly, 24/7."); ?></p>
						<div class="hero-btns">
							<a href="<?php echo site_url('home/sign_up'); ?>" class="main-btn btn-hover wow fadeInUp <?php if($this->config->item('enable_signup_form') =='0') echo "d-none"; ?>" data-wow-delay=".45s"><?php echo $this->lang->line("Start Selling Smarter"); ?></a>
							<?php 
						...
						<div class="hero-stats row wow fadeInUp" data-wow-delay=".6s">
							<div class="col-4">
								<h4><span class="counter">24</span>/7</h4>
								<p><?php echo $this->lang->line("AI Online"); ?></p>
							</div>
							<div class="col-4">
								<h4>&lt;3s</h4>
								<p><?php echo $this->lang->line("Avg Reply"); ?></p>
							</div>
							<div class="col-4">
								<h4>100%</h4>
								<p><?php echo $this->lang->line("Personalized"); ?></p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-1 wow fadeInUp" data-wow-delay=".2s">
						...
						<div class="feature-content">
							<h4><?php echo $this->lang->line("AI-Powered Replies"); ?></h4>
							<p><?php echo $this->lang->line("Smart AI understands customer intent and replies naturally to build trust and drive action."); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-2 wow fadeInUp" data-wow-delay=".4s">
						...
						<div class="feature-content">
							<h4><?php echo $this->lang->line("Customized Responses"); ?></h4>
							<p><?php echo $this->lang->line("Every reply is tailored to the exact comment or message so customers feel heard, not spammed."); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-3 wow fadeInUp" data-wow-delay=".6s">
						...
						<div class="feature-content">
							<h4><?php echo $this->lang->line("Lightning-Fast Speed"); ?></h4>
							<p><?php echo $this->lang->line("Fast response speed is what attracts and engages customers. Reply in seconds, never miss a lead."); ?></p>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-6">
					<div class="single-feature item-4 wow fadeInUp" data-wow-delay=".8s">
						...
						<div class="feature-content">
							<h4><?php echo $this->lang->line("Professional Sales Tool"); ?></h4>
							<p><?php echo $this->lang->line("This is not just a bot. monkey bot is built specifically to sell to your customers and grow revenue."); ?></p>
						</div>
					</div>
				</div>
			</div>
