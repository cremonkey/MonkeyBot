...
CREATE TABLE IF NOT EXISTS `open_ai_config` (
  ...
  `sales_mode_enabled` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `sales_system_prompt` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `max_history_messages` int(11) NOT NULL DEFAULT '6',
  `temperature` decimal(3,2) NOT NULL DEFAULT '0.70',
  `memory_ttl_hours` int(11) NOT NULL DEFAULT '24',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ai_conversation_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT 'ChatPion account owner',
  `page_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Facebook/Instagram page ID',
  `subscribe_id` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Subscriber PSID',
  `social_media` enum('fb','ig') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'fb',
  `human_message` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `ai_reply` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `conversation_lookup` (`user_id`,`page_id`,`subscribe_id`,`social_media`,`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
